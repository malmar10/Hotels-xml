...
namespace ConsoleApp1
{
    public class Program
    {
        ...
        public static string xmlURL = "hotels-xml/Hotels.xml";
        public static string xmlErrorURL = "hotels-xml/HotelsErrors.xml";
        public static string xsdURL = "hotels-xml/Hotels.xsd";
